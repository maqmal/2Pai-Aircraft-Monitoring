...
function showPosition(position) {
    // -6.921507, 107.617751 bdg
    var latt = (position.coords.latitude)-0.7;
    var long = (position.coords.longitude)+0.8;
    console.log('Your latitude is :'+latt+' and longitude is '+long);
      ...
      function theResponse(response) {
        ...
        x.innerHTML = "Wind Speed : "+jsonObject.wind.speed+" m/s"+"<br>"+
        "Wind Direction : "+compas+" "+jsonObject.wind.deg+"°";
      }
